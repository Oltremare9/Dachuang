package com.example.tianzhang.jsonandroid;
...
import com.example.tianzhang.myui.MainActivity;
...
public class LoginActivity extends Activity {
    ...
    public void loginRemoteService(String userName,String password){
        ...
        try {
            ...
            System.out.print("json0"+entity);
            //获取响应的结果信息
            String json =EntityUtils.toString(entity,"UTF-8");
            System.out.print("json1"+json);
            //JSON的解析过程
            if(json!=null){
                JSONObject jsonObject=new JSONObject(json);
                result=jsonObject.get("message").toString();
                System.out.print("json2"+json);
            }
            if(result==null){
                json="登录失败请重新登录";
            }
